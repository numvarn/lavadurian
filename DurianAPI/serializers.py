...
class StoreRegisSerializer(serializers.ModelSerializer):
    class Meta:
        model = Store
        fields = ['name', 'slogan', 'about', 'phone1', 'phone2', 'district', 'status']
...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model =  Product
        fields = ['grade', 'gene', 'values', 'price', 'weight', 'desc', 'status']
...
class BookBankSerializer(serializers.ModelSerializer):
    class Meta:
        model = BookBank
        fields = ['store', 'bank', 'bank_branch', 'account_type', 'account_name', 'account_number']
