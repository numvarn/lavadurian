...
urlpatterns = [
    ...
    path('store/manage/<int:id>/sales/', views.stroeSalesCheck, name='store-sales'),
    path('store/product/<int:id>', views.storeProductDetail, name='store-product'),
    path('store/product/<int:id>/edit/', views.storeProductEdit, name='store-product-edit'),
    path('store/product/<int:id>/delete/', views.deleteProduct, name='store-product-delete'),
    path('store/certificate/<int:id>', views.showCertificate, name='store-certificate'),
    ...
    path('shopping/product/<int:id>', views.shoppingProductView, name='shopping-product-view'),
    path('bookbank/save/', views.storeAddBookBank),
    path('bookbank/<int:id>/delte/', views.storeDeleteBookBank, name="bookbank-delete"),
